...
part 'pokemon_query.var.gql.g.dart';
...
abstract class GPokemonsVars
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GPokemonsVars.serializer, this)
          as Map<String, dynamic>);
  static GPokemonsVars? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GPokemonsVars.serializer, json);
}
