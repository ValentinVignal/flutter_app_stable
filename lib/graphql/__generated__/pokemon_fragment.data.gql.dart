...
part 'pokemon_fragment.data.gql.g.dart';
...
abstract class GPokemonFragmentData
  ...
  static void _initializeBuilder(GPokemonFragmentDataBuilder b) =>
      b..G__typename = 'PokemonInterface';
  @override
  ...
  @override
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GPokemonFragmentData.serializer, this)
          as Map<String, dynamic>);
  static GPokemonFragmentData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GPokemonFragmentData.serializer, json);
}
