...
part 'pokemon_query.data.gql.g.dart';
...
abstract class GPokemonsData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GPokemonsData.serializer, this)
          as Map<String, dynamic>);
  static GPokemonsData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GPokemonsData.serializer, json);
}
...
abstract class GPokemonsData_pokemons
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GPokemonsData_pokemons.serializer, this)
          as Map<String, dynamic>);
  static GPokemonsData_pokemons? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GPokemonsData_pokemons.serializer, json);
}
