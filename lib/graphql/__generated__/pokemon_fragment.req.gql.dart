...
part 'pokemon_fragment.req.gql.g.dart';
...
abstract class GPokemonFragmentReq
  ...
  Map<String, dynamic> toJson() =>
      (_i6.serializers.serializeWith(GPokemonFragmentReq.serializer, this)
          as Map<String, dynamic>);
  static GPokemonFragmentReq? fromJson(Map<String, dynamic> json) =>
      _i6.serializers.deserializeWith(GPokemonFragmentReq.serializer, json);
}
